      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <PersianText className='text-sm'>بازگشت</PersianText>
          </Button>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  <PersianText>کد قطعه *</PersianText>
                </label>
                <input
                  type="text"
                  required
              ...
              <div>
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 text-black px-3 py-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
                  <select
                    value={formData.currency}
                    onChange={(e) => handleInputChange('currency', e.target.value)}
                    className="px-3 py-2 text-black border border-gray-300 border-r-0 rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                    {currencies.map(curr => (
          ...
          <Card className="p-6">
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                className="w-full text-black px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder=" مثال: پک، ولتاژ، توان، جریان و ..." 
              />
            </div>
              ...
              {formData.specifications.map((spec, index) => (
                <div key={index} className="flex gap-3 items-center">
                  ...
                  <input
                    ...
                    className="w-24 px-3 py-2 text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
